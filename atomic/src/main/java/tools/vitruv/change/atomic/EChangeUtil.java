...
public class EChangeUtil {
  ...
  /**
   * Tests if change represents the removal of an {@link EObject} from the
   ...
   * <ol>
   * <li>
   * change replaces an EObject in a single-valued containment reference, in which
   * case
   * that EObject is considered to be removed (ReplaceSingleValuedEReference),
   * </li>
   * <li>change removes an EObject from a containment reference
   * (RemoveEReference), or</li>
  ...
  /**
   * Tests if change represents the insertion of an {@link EObject} into the
   * containment hierarchy.
   * 
   * <p>
   * This is the case when:
   * <ol>
   * <li>
   * change adds an EObject into a containment reference
   * (AdditiveReferenceEChange), or:
   * </li>
   * <li>change inserts or removes a root object
   * (InsertRootEObject/RemoveRootEObject).</li>
   * </ol>
   *
   * @param change - {@link EChange}
   * @return a boolean value.
