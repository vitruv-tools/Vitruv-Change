...
/**
 * Switch to create commands for all EChange classes. The commands applies the
 * EChanges forward.
 */
class ApplyForwardCommandSwitch extends ApplyCommandSwitch {
  private static final String CONTAINMENT_OPPOSITE_WARNING = "but although there is no opposite feature it was already contained in %s";
  ...
  /**
   * Method to create commands to apply a {@link InsertEAttributeValue} change
   * forward.
   *
   * @param change The change for which commands should be created.
  ...
  /**
   * Method to create commands to apply a {@link RemoveEAttributeValue} change
   * forward.
   *
   * @param change The change for which commands should be created.
  ...
  /**
   * Method to create commands to apply a {@link ReplaceSingleValuedEAttribute}
   * change forward.
   *
   * @param change The change for which commands should be created.
   * @return List of SetCommand
  ...
  /**
   * Method to create commands to apply a {@link ReplaceSingleValuedEReference}
   * change forward.
   *
   * @param change The change for which commands should be created.
  ...
  /**
   * Method to create commands to apply a {@link InsertRootEObject} change
   * forward.
   *
   * @param change The change for which commands should be created.
   * @return List of AddCommand
  ...
  List<Command> getCommands(InsertRootEObject<EObject> change) {
    // Will be automatically removed from resource because object can only be in one
    // resource.
  ...
  /**
   * Method to create commands to apply a {@link RemoveRootEObject} change
   * forward.
   *
   * @param change The change for which commands should be created.
   * @return List of RemoveAtCommand
