...
public interface ChangePropagationSpecification extends ChangePropagationObservable {
   ...
   */
  boolean doesHandleChange(final EChange<EObject> change, final EditableCorrespondenceModelView<Correspondence> correspondenceModel);
   ...
   */
  void propagateChange(final EChange<EObject> change, final EditableCorrespondenceModelView<Correspondence> correspondenceModel, final ResourceAccess resourceAccess);
}
