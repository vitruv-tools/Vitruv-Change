...
public interface TextInputInteractionBuilder {
   ...
   */
  interface OptionalSteps extends InteractionBuilder<String, TextInputInteractionBuilder.OptionalSteps> {
    /**
     ...
     */
    TextInputInteractionBuilder.OptionalSteps inputValidator(final UserInteractionOptions.InputValidator inputValidator);
     ...
     * The default input validator accepts all input.
     */
    TextInputInteractionBuilder.OptionalSteps inputValidator(final Function<String, Boolean> validatorFunction, final String invalidInputMessage);
     ...
     */
    TextInputInteractionBuilder.OptionalSteps inputFieldType(final UserInteractionOptions.InputFieldType inputFieldType);
  }
   ...
   */
  TextInputInteractionBuilder.OptionalSteps message(final String message);
}
