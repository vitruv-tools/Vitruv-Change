...
public interface InteractionBuilder<V extends Object, T extends InteractionBuilder<V, T>> {
  /**
   ...
   * @return a matching DialogBuilder implementation for method chaining.
   */
  T windowModality(final UserInteractionOptions.WindowModality windowModality);
   ...
   * @return a matching DialogBuilder implementation for method chaining.
   */
  T positiveButtonText(final String text);
   ...
   * @return a matching DialogBuilder implementation for method chaining.
   */
  T negativeButtonText(final String text);
   ...
   * @return a matching DialogBuilder implementation for method chaining.
   */
  T cancelButtonText(final String text);
