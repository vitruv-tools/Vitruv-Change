...
public interface NotificationInteractionBuilder {
   ...
   */
  interface OptionalSteps extends InteractionBuilder<Void, NotificationInteractionBuilder.OptionalSteps> {
    /**
     ...
     */
    NotificationInteractionBuilder.OptionalSteps notificationType(final UserInteractionOptions.NotificationType type);
  }
   ...
   */
  NotificationInteractionBuilder.OptionalSteps message(final String message);
}
