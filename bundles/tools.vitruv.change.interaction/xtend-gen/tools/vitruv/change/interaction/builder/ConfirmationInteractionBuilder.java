...
public interface ConfirmationInteractionBuilder {
   ...
   * build process.
   */
  interface OptionalSteps extends InteractionBuilder<Boolean, ConfirmationInteractionBuilder.OptionalSteps> {
  }
   ...
   */
  ConfirmationInteractionBuilder.OptionalSteps message(final String message);
}
