	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case InteractionPackage.FREE_TEXT_USER_INTERACTION:
			{
				...
				if (result == null) result = caseUserInteractionBase(freeTextUserInteraction);
			...
			case InteractionPackage.MULTIPLE_CHOICE_SINGLE_SELECTION_USER_INTERACTION:
			{
				...
				if (result == null) result = caseMultipleChoiceSelectionInteractionBase(multipleChoiceSingleSelectionUserInteraction);
				if (result == null) result = caseUserInteractionBase(multipleChoiceSingleSelectionUserInteraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.MULTIPLE_CHOICE_MULTI_SELECTION_USER_INTERACTION:
			{
				...
				if (result == null) result = caseMultipleChoiceSelectionInteractionBase(multipleChoiceMultiSelectionUserInteraction);
				if (result == null) result = caseUserInteractionBase(multipleChoiceMultiSelectionUserInteraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.CONFIRMATION_USER_INTERACTION:
			{
				...
				if (result == null) result = caseUserInteractionBase(confirmationUserInteraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case InteractionPackage.MULTIPLE_CHOICE_SELECTION_INTERACTION_BASE:
			{
				...
				if (result == null) result = caseUserInteractionBase(multipleChoiceSelectionInteractionBase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InteractionPackage.NOTIFICATION_USER_INTERACTION:
			{
				...
				if (result == null) result = caseUserInteractionBase(notificationUserInteraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
