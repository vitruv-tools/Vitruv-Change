 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.change.interaction.impl.MultipleChoiceSelectionInteractionBaseImpl#getChoices <em>Choices</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MultipleChoiceSelectionInteractionBaseImpl extends UserInteractionBaseImpl implements MultipleChoiceSelectionInteractionBase
{
	...
	public EList<String> getChoices()
	{
		if (choices == null)
		{
			choices = new EDataTypeUniqueEList.Unsettable<String>(String.class, this, InteractionPackage.MULTIPLE_CHOICE_SELECTION_INTERACTION_BASE__CHOICES);
		}
		return choices;
	}
	...
	{
		if (choices != null) ((InternalEList.Unsettable<?>)choices).unset();
	}
