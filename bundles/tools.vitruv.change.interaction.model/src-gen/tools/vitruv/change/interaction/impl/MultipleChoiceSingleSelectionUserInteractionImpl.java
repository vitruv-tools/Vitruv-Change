 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.change.interaction.impl.MultipleChoiceSingleSelectionUserInteractionImpl#getSelectedIndex <em>Selected Index</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultipleChoiceSingleSelectionUserInteractionImpl extends MultipleChoiceSelectionInteractionBaseImpl implements MultipleChoiceSingleSelectionUserInteraction
{
	...
	public void setSelectedIndex(int newSelectedIndex)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.MULTIPLE_CHOICE_SINGLE_SELECTION_USER_INTERACTION__SELECTED_INDEX, oldSelectedIndex, selectedIndex));
	}
