...
public class InteractionFactoryImpl extends EFactoryImpl implements InteractionFactory
{
	...
	public EObject create(EClass eClass)
	{
		...
		{
			case InteractionPackage.FREE_TEXT_USER_INTERACTION: return createFreeTextUserInteraction();
			case InteractionPackage.MULTIPLE_CHOICE_SINGLE_SELECTION_USER_INTERACTION: return createMultipleChoiceSingleSelectionUserInteraction();
			case InteractionPackage.MULTIPLE_CHOICE_MULTI_SELECTION_USER_INTERACTION: return createMultipleChoiceMultiSelectionUserInteraction();
			case InteractionPackage.CONFIRMATION_USER_INTERACTION: return createConfirmationUserInteraction();
			case InteractionPackage.NOTIFICATION_USER_INTERACTION: return createNotificationUserInteraction();
			default:
