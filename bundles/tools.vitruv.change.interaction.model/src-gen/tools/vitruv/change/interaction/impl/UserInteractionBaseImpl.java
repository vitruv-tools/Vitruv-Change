 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.change.interaction.impl.UserInteractionBaseImpl#getMessage <em>Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UserInteractionBaseImpl extends MinimalEObjectImpl.Container implements UserInteractionBase
{
	...
	public void setMessage(String newMessage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteractionPackage.USER_INTERACTION_BASE__MESSAGE, oldMessage, message, !oldMessageESet));
	}
	...
	public void unsetMessage()
	{
		...
		messageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, InteractionPackage.USER_INTERACTION_BASE__MESSAGE, oldMessage, MESSAGE_EDEFAULT, oldMessageESet));
	}
