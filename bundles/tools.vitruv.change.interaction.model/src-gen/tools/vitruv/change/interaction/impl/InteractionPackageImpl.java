...
public class InteractionPackageImpl extends EPackageImpl implements InteractionPackage
{
	 ...
	 * @see tools.vitruv.change.interaction.InteractionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void createPackageContents()
	{
		...
		multipleChoiceSingleSelectionUserInteractionEClass = createEClass(MULTIPLE_CHOICE_SINGLE_SELECTION_USER_INTERACTION);
		createEAttribute(multipleChoiceSingleSelectionUserInteractionEClass, MULTIPLE_CHOICE_SINGLE_SELECTION_USER_INTERACTION__SELECTED_INDEX);

		multipleChoiceMultiSelectionUserInteractionEClass = createEClass(MULTIPLE_CHOICE_MULTI_SELECTION_USER_INTERACTION);
		createEAttribute(multipleChoiceMultiSelectionUserInteractionEClass, MULTIPLE_CHOICE_MULTI_SELECTION_USER_INTERACTION__SELECTED_INDICES);
		...
		createEAttribute(multipleChoiceSelectionInteractionBaseEClass, MULTIPLE_CHOICE_SELECTION_INTERACTION_BASE__CHOICES);
	...
	public void initializePackageContents()
	{
		...
		multipleChoiceSingleSelectionUserInteractionEClass.getESuperTypes().add(this.getMultipleChoiceSelectionInteractionBase());
		multipleChoiceMultiSelectionUserInteractionEClass.getESuperTypes().add(this.getMultipleChoiceSelectionInteractionBase());
		...
		initEClass(freeTextUserInteractionEClass, FreeTextUserInteraction.class, "FreeTextUserInteraction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFreeTextUserInteraction_Text(), ecorePackage.getEString(), "text", null, 0, 1, FreeTextUserInteraction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(multipleChoiceSingleSelectionUserInteractionEClass, MultipleChoiceSingleSelectionUserInteraction.class, "MultipleChoiceSingleSelectionUserInteraction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMultipleChoiceSingleSelectionUserInteraction_SelectedIndex(), ecorePackage.getEInt(), "selectedIndex", null, 0, 1, MultipleChoiceSingleSelectionUserInteraction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(multipleChoiceMultiSelectionUserInteractionEClass, MultipleChoiceMultiSelectionUserInteraction.class, "MultipleChoiceMultiSelectionUserInteraction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMultipleChoiceMultiSelectionUserInteraction_SelectedIndices(), ecorePackage.getEInt(), "selectedIndices", null, 0, -1, MultipleChoiceMultiSelectionUserInteraction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(confirmationUserInteractionEClass, ConfirmationUserInteraction.class, "ConfirmationUserInteraction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getConfirmationUserInteraction_Confirmed(), ecorePackage.getEBoolean(), "confirmed", null, 0, 1, ConfirmationUserInteraction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(userInteractionBaseEClass, UserInteractionBase.class, "UserInteractionBase", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUserInteractionBase_Message(), ecorePackage.getEString(), "message", null, 0, 1, UserInteractionBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(multipleChoiceSelectionInteractionBaseEClass, MultipleChoiceSelectionInteractionBase.class, "MultipleChoiceSelectionInteractionBase", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMultipleChoiceSelectionInteractionBase_Choices(), ecorePackage.getEString(), "choices", null, 0, -1, MultipleChoiceSelectionInteractionBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(notificationUserInteractionEClass, NotificationUserInteraction.class, "NotificationUserInteraction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
