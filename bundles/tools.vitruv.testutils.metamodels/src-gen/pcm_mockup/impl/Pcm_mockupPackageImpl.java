...
public class Pcm_mockupPackageImpl extends EPackageImpl implements Pcm_mockupPackage
{
	...
	public static Pcm_mockupPackage init()
	{
		...
		Object registeredPcm_mockupPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Pcm_mockupPackageImpl thePcm_mockupPackage = registeredPcm_mockupPackage instanceof Pcm_mockupPackageImpl ? (Pcm_mockupPackageImpl)registeredPcm_mockupPackage : new Pcm_mockupPackageImpl();
	...
	{
		return (EReference)pMethodEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents()
	{
		...
		createEReference(pMethodEClass, PMETHOD__RETURN_TYPE);
	}
	...
	public void initializePackageContents()
	{
		...
		initEReference(getPMethod_ReturnType(), this.getPInterface(), null, "returnType", null, 0, 1, PMethod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
