...
public interface Uml_mockupPackage extends EPackage
{
	 ...
	 * @generated
	 */
	String eNS_URI = "http://tools.vitruv.testutils.metamodels.uml_mockup";
	...
	/**
	 * Returns the meta object for the containment reference list '{@link uml_mockup.UClass#getAttributes <em>Attributes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
