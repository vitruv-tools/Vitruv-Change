...
public class Multicontainment_aPackageImpl extends EPackageImpl implements Multicontainment_aPackage
{
	...
	public static Multicontainment_aPackage init()
	{
		...
		Object registeredMulticontainment_aPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Multicontainment_aPackageImpl theMulticontainment_aPackage = registeredMulticontainment_aPackage instanceof Multicontainment_aPackageImpl ? (Multicontainment_aPackageImpl)registeredMulticontainment_aPackage : new Multicontainment_aPackageImpl();
