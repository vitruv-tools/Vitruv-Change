...
public class AllElementTypesSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case AllElementTypesPackage.NON_ROOT:
			{
				...
				if (result == null) result = caseContainable(nonRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AllElementTypesPackage.VALUE_BASED:
			{
				ValueBased valueBased = (ValueBased)theEObject;
				T result = caseValueBased(valueBased);
				if (result == null) result = caseContainable(valueBased);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AllElementTypesPackage.CONTAINABLE:
			{
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Value Based</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Value Based</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseValueBased(ValueBased object)
	{
		return null;
	}
