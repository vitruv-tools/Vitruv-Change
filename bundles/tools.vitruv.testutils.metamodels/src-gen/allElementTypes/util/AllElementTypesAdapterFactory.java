...
public class AllElementTypesAdapterFactory extends AdapterFactoryImpl
{
	...
	protected AllElementTypesSwitch<Adapter> modelSwitch =
		new AllElementTypesSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseValueBased(ValueBased object)
			{
				return createValueBasedAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link allElementTypes.ValueBased <em>Value Based</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link allElementTypes.Containable <em>Containable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
