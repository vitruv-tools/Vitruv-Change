...
public class AllElementTypesFactoryImpl extends EFactoryImpl implements AllElementTypesFactory
{
	...
	public EObject create(EClass eClass)
	{
		switch (eClass.getClassifierID())
		{
			...
			case AllElementTypesPackage.VALUE_BASED: return createValueBased();
			case AllElementTypesPackage.CONTAINABLE: return createContainable();
			default:
	...
	{
		ValueBasedImpl valueBased = new ValueBasedImpl();
		return valueBased;
	}
	...
	{
		ContainableImpl containable = new ContainableImpl();
		return containable;
	}
