...
public class NonRootObjectContainerHelperImpl extends IdentifiedImpl implements NonRootObjectContainerHelper
{
	...
	public EList<NonRoot> getNonRootObjectsContainment()
	{
		...
		{
			nonRootObjectsContainment = new EObjectContainmentEList.Resolving<NonRoot>(NonRoot.class, this, AllElementTypesPackage.NON_ROOT_OBJECT_CONTAINER_HELPER__NON_ROOT_OBJECTS_CONTAINMENT);
		}
