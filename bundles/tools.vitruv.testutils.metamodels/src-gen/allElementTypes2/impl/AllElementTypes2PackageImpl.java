...
public class AllElementTypes2PackageImpl extends EPackageImpl implements AllElementTypes2Package
{
	...
	public static AllElementTypes2Package init()
	{
		...
		Object registeredAllElementTypes2Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		AllElementTypes2PackageImpl theAllElementTypes2Package = registeredAllElementTypes2Package instanceof AllElementTypes2PackageImpl ? (AllElementTypes2PackageImpl)registeredAllElementTypes2Package : new AllElementTypes2PackageImpl();
	...
	{
		return (EAttribute)root2EClass.getEStructuralFeatures().get(1);
	}
	...
	{
		return (EReference)root2EClass.getEStructuralFeatures().get(3);
	}
	...
	{
		return (EAttribute)root2EClass.getEStructuralFeatures().get(4);
	}
	...
	{
		return (EReference)root2EClass.getEStructuralFeatures().get(7);
	}
	...
	public void createPackageContents()
	{
		...
		createEAttribute(root2EClass, ROOT2__SINGLE_VALUED_PRIMITIVE_TYPE_EATTRIBUTE2);
	...
	public void initializePackageContents()
	{
		...
		initEAttribute(getRoot2_SingleValuedPrimitiveTypeEAttribute2(), ecorePackage.getEInt(), "singleValuedPrimitiveTypeEAttribute2", null, 0, 1, Root2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
