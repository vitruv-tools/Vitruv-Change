...
public class RootSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case RootPackage.ROOT_ECHANGE:
			{
				...
				T result = caseRootEChange(rootEChange);
			...
			case RootPackage.INSERT_ROOT_EOBJECT:
			{
				...
				T result = caseInsertRootEObject(insertRootEObject);
			...
			case RootPackage.REMOVE_ROOT_EOBJECT:
			{
				...
				T result = caseRemoveRootEObject(removeRootEObject);
	 ...
	 * @generated
	 */
	public <Element extends Object> T caseRootEChange(RootEChange<Element> object)
	{
		return null;
	}
	 ...
	 * @generated
	 */
	public <Element extends Object> T caseInsertRootEObject(InsertRootEObject<Element> object)
	{
		return null;
	}
	 ...
	 * @generated
	 */
	public <Element extends Object> T caseRemoveRootEObject(RemoveRootEObject<Element> object)
	{
		return null;
	}
