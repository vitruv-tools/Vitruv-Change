 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see tools.vitruv.change.atomic.feature.single.SingleFactory
 * @model kind="package"
 * @generated
 */
public interface SinglePackage extends EPackage
{
	 ...
	 * @generated
	 */
	String eNS_URI = "http://vitruv.tools/metamodels/change/atomic/feature/single/2.0";
	 ...
	 * @generated
	 */
	SinglePackage eINSTANCE = tools.vitruv.change.atomic.feature.single.impl.SinglePackageImpl.init();

	/**
	 * The meta object id for the '{@link tools.vitruv.change.atomic.feature.single.impl.ReplaceSingleValuedFeatureEChangeImpl <em>Replace Single Valued Feature EChange</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.change.atomic.feature.single.impl.ReplaceSingleValuedFeatureEChangeImpl
	 * @see tools.vitruv.change.atomic.feature.single.impl.SinglePackageImpl#getReplaceSingleValuedFeatureEChange()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int REPLACE_SINGLE_VALUED_FEATURE_ECHANGE__AFFECTED_ELEMENT = FeaturePackage.UPDATE_SINGLE_VALUED_FEATURE_ECHANGE__AFFECTED_ELEMENT;
	...
	/**
	 * Returns the meta object for class '{@link tools.vitruv.change.atomic.feature.single.ReplaceSingleValuedFeatureEChange <em>Replace Single Valued Feature EChange</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link tools.vitruv.change.atomic.feature.single.ReplaceSingleValuedFeatureEChange#isIsUnset <em>Is Unset</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is Unset</em>'.
	 * @see tools.vitruv.change.atomic.feature.single.ReplaceSingleValuedFeatureEChange#isIsUnset()
	...
	/**
	 * Returns the meta object for the '{@link tools.vitruv.change.atomic.feature.single.ReplaceSingleValuedFeatureEChange#isFromNonDefaultValue() <em>Is From Non Default Value</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Is From Non Default Value</em>' operation.
	 * @see tools.vitruv.change.atomic.feature.single.ReplaceSingleValuedFeatureEChange#isFromNonDefaultValue()
	 * @generated
	 */
	EOperation getReplaceSingleValuedFeatureEChange__IsFromNonDefaultValue();

	/**
	 * Returns the meta object for the '{@link tools.vitruv.change.atomic.feature.single.ReplaceSingleValuedFeatureEChange#isToNonDefaultValue() <em>Is To Non Default Value</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Is To Non Default Value</em>' operation.
	 * @see tools.vitruv.change.atomic.feature.single.ReplaceSingleValuedFeatureEChange#isToNonDefaultValue()
	 * @generated
	 */
	...
	{
		/**
		 * The meta object literal for the '{@link tools.vitruv.change.atomic.feature.single.impl.ReplaceSingleValuedFeatureEChangeImpl <em>Replace Single Valued Feature EChange</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.change.atomic.feature.single.impl.ReplaceSingleValuedFeatureEChangeImpl
		 * @see tools.vitruv.change.atomic.feature.single.impl.SinglePackageImpl#getReplaceSingleValuedFeatureEChange()
