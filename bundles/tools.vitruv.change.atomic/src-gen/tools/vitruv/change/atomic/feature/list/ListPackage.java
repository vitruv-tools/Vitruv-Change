 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see tools.vitruv.change.atomic.feature.list.ListFactory
 * @model kind="package"
 * @generated
 */
public interface ListPackage extends EPackage
{
	 ...
	 * @generated
	 */
	String eNS_URI = "http://vitruv.tools/metamodels/change/atomic/feature/list/2.0";
	 ...
	 * @generated
	 */
	ListPackage eINSTANCE = tools.vitruv.change.atomic.feature.list.impl.ListPackageImpl.init();

	/**
	 * The meta object id for the '{@link tools.vitruv.change.atomic.feature.list.impl.UpdateSingleListEntryEChangeImpl <em>Update Single List Entry EChange</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.change.atomic.feature.list.impl.UpdateSingleListEntryEChangeImpl
	 * @see tools.vitruv.change.atomic.feature.list.impl.ListPackageImpl#getUpdateSingleListEntryEChange()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int UPDATE_SINGLE_LIST_ENTRY_ECHANGE__AFFECTED_ELEMENT = FeaturePackage.UPDATE_MULTI_VALUED_FEATURE_ECHANGE__AFFECTED_ELEMENT;
	...
	/**
	 * The meta object id for the '{@link tools.vitruv.change.atomic.feature.list.impl.InsertInListEChangeImpl <em>Insert In List EChange</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.change.atomic.feature.list.impl.InsertInListEChangeImpl
	 * @see tools.vitruv.change.atomic.feature.list.impl.ListPackageImpl#getInsertInListEChange()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int INSERT_IN_LIST_ECHANGE__AFFECTED_ELEMENT = UPDATE_SINGLE_LIST_ENTRY_ECHANGE__AFFECTED_ELEMENT;
	...
	/**
	 * The meta object id for the '{@link tools.vitruv.change.atomic.feature.list.impl.RemoveFromListEChangeImpl <em>Remove From List EChange</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see tools.vitruv.change.atomic.feature.list.impl.RemoveFromListEChangeImpl
	 * @see tools.vitruv.change.atomic.feature.list.impl.ListPackageImpl#getRemoveFromListEChange()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int REMOVE_FROM_LIST_ECHANGE__AFFECTED_ELEMENT = UPDATE_SINGLE_LIST_ENTRY_ECHANGE__AFFECTED_ELEMENT;
	...
	/**
	 * Returns the meta object for class '{@link tools.vitruv.change.atomic.feature.list.UpdateSingleListEntryEChange <em>Update Single List Entry EChange</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link tools.vitruv.change.atomic.feature.list.UpdateSingleListEntryEChange#getIndex <em>Index</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Index</em>'.
	 * @see tools.vitruv.change.atomic.feature.list.UpdateSingleListEntryEChange#getIndex()
	...
	/**
	 * Returns the meta object for class '{@link tools.vitruv.change.atomic.feature.list.InsertInListEChange <em>Insert In List EChange</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link tools.vitruv.change.atomic.feature.list.RemoveFromListEChange <em>Remove From List EChange</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	{
		/**
		 * The meta object literal for the '{@link tools.vitruv.change.atomic.feature.list.impl.UpdateSingleListEntryEChangeImpl <em>Update Single List Entry EChange</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.change.atomic.feature.list.impl.UpdateSingleListEntryEChangeImpl
		 * @see tools.vitruv.change.atomic.feature.list.impl.ListPackageImpl#getUpdateSingleListEntryEChange()
		...
		/**
		 * The meta object literal for the '{@link tools.vitruv.change.atomic.feature.list.impl.InsertInListEChangeImpl <em>Insert In List EChange</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.change.atomic.feature.list.impl.InsertInListEChangeImpl
		 * @see tools.vitruv.change.atomic.feature.list.impl.ListPackageImpl#getInsertInListEChange()
		...
		/**
		 * The meta object literal for the '{@link tools.vitruv.change.atomic.feature.list.impl.RemoveFromListEChangeImpl <em>Remove From List EChange</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see tools.vitruv.change.atomic.feature.list.impl.RemoveFromListEChangeImpl
		 * @see tools.vitruv.change.atomic.feature.list.impl.ListPackageImpl#getRemoveFromListEChange()
