...
import tools.vitruv.change.atomic.feature.single.*;
 ...
 * <!-- end-user-doc -->
 * @see tools.vitruv.change.atomic.feature.single.SinglePackage
 * @generated
 */
public class SingleSwitch<T> extends Switch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case SinglePackage.REPLACE_SINGLE_VALUED_FEATURE_ECHANGE:
			{
				...
				T result = caseReplaceSingleValuedFeatureEChange(replaceSingleValuedFeatureEChange);
