...
final class ApplyBackwardCommandSwitch {
  private static final Logger logger = Logger.getLogger(ApplyBackwardCommandSwitch.class);
  ...
  static List<Command> _getCommands(final InsertEAttributeValue<EObject, ?> change) {
    ...
    boolean _isWasUnset = change.isWasUnset();
    if (_isWasUnset) {
      ...
      EAttribute _affectedFeature_1 = change.getAffectedFeature();
      Object _newValue = change.getNewValue();
      int _index = change.getIndex();
      RemoveAtCommand _removeAtCommand = new RemoveAtCommand(editingDomain, _affectedElement_1, _affectedFeature_1, _newValue, _index);
  ...
  static List<Command> _getCommands(final RemoveEAttributeValue<EObject, ?> change) {
    ...
    int _index = change.getIndex();
    AddCommand _addCommand = new AddCommand(editingDomain, _affectedElement, _affectedFeature, _oldValue, _index);
  ...
  static List<Command> _getCommands(final ReplaceSingleValuedEAttribute<EObject, ?> change) {
    ...
    if (_isWasUnset) {
      ...
      _xifexpression = change.getOldValue();
    }
  ...
  static List<Command> _getCommands(final InsertEReference<EObject> change) {
    ...
    if (_not) {
      ...
      if (_tripleEquals) {
        ...
        String _plus = ("Tried to remove value " + _newValue);
        String _plus_1 = (_plus + ", but although there is no opposite feature it was not contained in ");
        EObject _affectedElement = change.getAffectedElement();
        String _plus_2 = (_plus_1 + _affectedElement);
        ApplyBackwardCommandSwitch.logger.warn(_plus_2);
      }
      return Collections.<Command>unmodifiableList(CollectionLiterals.<Command>newArrayList());
    }
    boolean _isWasUnset = change.isWasUnset();
    if (_isWasUnset) {
      ...
      SetCommand _setCommand = new SetCommand(editingDomain, _affectedElement_1, _affectedFeature, SetCommand.UNSET_VALUE);
      return Collections.<Command>unmodifiableList(CollectionLiterals.<Command>newArrayList(_setCommand));
    } else {
      EObject _affectedElement_2 = change.getAffectedElement();
      EReference _affectedFeature_1 = change.getAffectedFeature();
      EObject _newValue_1 = change.getNewValue();
      int _index = change.getIndex();
      RemoveAtCommand _removeAtCommand = new RemoveAtCommand(editingDomain, _affectedElement_2, _affectedFeature_1, _newValue_1, _index);
      return Collections.<Command>unmodifiableList(CollectionLiterals.<Command>newArrayList(_removeAtCommand));
    }
  }
  ...
  static List<Command> _getCommands(final RemoveEReference<EObject> change) {
    ...
    if (_alreadyContainsObject) {
      ...
      if (_tripleEquals) {
        ...
        String _plus = ("Tried to add value " + _oldValue);
    ...
    int _index = change.getIndex();
    AddCommand _addCommand = new AddCommand(editingDomain, _affectedElement_1, _affectedFeature, _oldValue_1, _index);
    return Collections.<Command>unmodifiableList(CollectionLiterals.<Command>newArrayList(_addCommand));
  }
  ...
  static List<Command> _getCommands(final InsertRootEObject<EObject> change) {
    ...
    EObject _newValue = change.getNewValue();
    RemoveCommand _removeCommand = new RemoveCommand(editingDomain, _contents, _newValue);
    return Collections.<Command>unmodifiableList(CollectionLiterals.<Command>newArrayList(_removeCommand));
  }
  ...
  static List<Command> _getCommands(final RemoveRootEObject<EObject> change) {
    ...
    EObject _oldValue = change.getOldValue();
    int _index = change.getIndex();
    AddCommand _addCommand = new AddCommand(editingDomain, _contents, _oldValue, _index);
    return Collections.<Command>unmodifiableList(CollectionLiterals.<Command>newArrayList(_addCommand));
  }
