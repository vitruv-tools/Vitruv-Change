...
public class DefaultPrintTargetTest {
  ...
  public void emptyByDefault() {
    MatcherAssert.<String>assertThat(
        new DefaultPrintTarget().toString(), CoreMatchers.<String>is(""));
  }

  @Test
  @DisplayName("indicates if printed text was empty")
  public void indicatesEmptyText() {
    MatcherAssert.<PrintResult>assertThat(
        new DefaultPrintTarget().print(""),
        CoreMatchers.<PrintResult>is(PrintResult.PRINTED_NO_OUTPUT));
    DefaultPrintTarget _defaultPrintTarget = new DefaultPrintTarget();
    final Consumer<DefaultPrintTarget> _function =
        (DefaultPrintTarget it) -> {
          it.print("preprint");
        };
    _function.accept(_defaultPrintTarget);
    MatcherAssert.assertThat(
        _defaultPrintTarget.print(""), CoreMatchers.<PrintResult>is(PrintResult.PRINTED_NO_OUTPUT));
  }
  ...
  public void indicatesNotEmptyText() {
    MatcherAssert.<PrintResult>assertThat(
        new DefaultPrintTarget().print(" "), CoreMatchers.<PrintResult>is(PrintResult.PRINTED));
    DefaultPrintTarget _defaultPrintTarget = new DefaultPrintTarget();
    final Consumer<DefaultPrintTarget> _function =
        (DefaultPrintTarget it) -> {
          it.print("");
    ...
    _function.accept(_defaultPrintTarget);
    MatcherAssert.assertThat(
        _defaultPrintTarget.print(" "), CoreMatchers.<PrintResult>is(PrintResult.PRINTED));
  }
  ...
  public void newlineAtStart() {
    ...
    final DefaultPrintTarget printed = _defaultPrintTarget;
    MatcherAssert.<String>assertThat(
        printed.toString(), CoreMatchers.<String>is(System.lineSeparator()));
  }
  ...
  public void newLinePrinted() {
    MatcherAssert.<PrintResult>assertThat(
        new DefaultPrintTarget().newLine(), CoreMatchers.<PrintResult>is(PrintResult.PRINTED));
  }
  ...
  public void emptyIterables() {
    final BiFunction<PrintTarget, Object, PrintResult> _function =
        (PrintTarget $0, Object $1) -> {
    ...
    DefaultPrintTarget _defaultPrintTarget = new DefaultPrintTarget();
    final Consumer<DefaultPrintTarget> _function_1 =
        (DefaultPrintTarget it) -> {
          it.<Object>printIterableElements(
              List.of(), PrintMode.SINGLE_LINE_LIST, shouldNotBeCalled);
        };
    ...
    final Consumer<DefaultPrintTarget> _function_2 =
        (DefaultPrintTarget it) -> {
          it.<Object>printIterable(
              "/{", "}!", List.of(), PrintMode.SINGLE_LINE_LIST, shouldNotBeCalled);
        };
    ...
    final Consumer<DefaultPrintTarget> _function_3 =
        (DefaultPrintTarget it) -> {
    ...
    final Consumer<DefaultPrintTarget> _function_4 =
        (DefaultPrintTarget it) -> {
  ...
  public void printedNoOutputIfNoOutputForIterable() {
    ...
    MatcherAssert.<PrintResult>assertThat(
        new DefaultPrintTarget()
            .<Object>printIterableElements(List.of(), PrintMode.SINGLE_LINE_LIST, _function),
        CoreMatchers.<PrintResult>is(PrintResult.PRINTED_NO_OUTPUT));
  }
  ...
  public void iterableSingleLine() {
    ...
    final Consumer<DefaultPrintTarget> _function =
        (DefaultPrintTarget it) -> {
          final BiFunction<PrintTarget, Integer, PrintResult> _function_1 =
              (PrintTarget $0, Integer $1) -> {
                return $0.print(String.valueOf($1));
              };
          it.<Integer>printIterable(
              "(",
              ")",
              List.<Integer>of(Integer.valueOf(1)),
              PrintMode.SINGLE_LINE_LIST,
              _function_1);
        };
    _function.accept(_defaultPrintTarget);
    DefaultPrintTarget printed = _defaultPrintTarget;
    ...
    final Consumer<DefaultPrintTarget> _function_1 =
        (DefaultPrintTarget it) -> {
          final BiFunction<PrintTarget, Integer, PrintResult> _function_2 =
              (PrintTarget $0, Integer $1) -> {
                return $0.print(String.valueOf($1));
              };
          it.<Integer>printIterable(
    ...
    printed = _doubleArrow;
    MatcherAssert.<String>assertThat(
        printed.toString(), CoreMatchers.<String>is("(1, 2, 3, 4, 5, 6)"));
  }
  ...
  public void iterableMultiLine() {
    ...
    final Consumer<DefaultPrintTarget> _function =
        (DefaultPrintTarget it) -> {
          final BiFunction<PrintTarget, String, PrintResult> _function_1 =
              (PrintTarget $0, String $1) -> {
                return $0.print($1);
              };
    ...
    final Consumer<DefaultPrintTarget> _function_2 =
        (DefaultPrintTarget it) -> {
          final BiFunction<PrintTarget, Integer, PrintResult> _function_3 =
              (PrintTarget $0, Integer $1) -> {
                return $0.print(String.valueOf($1));
              };
          it.<Integer>printIterable(
  ...
  public void iterableMultilineThreshold() {
    ...
    final Consumer<DefaultPrintTarget> _function_1 =
        (DefaultPrintTarget it) -> {
          ...
          it.<Integer>printIterable(
              "(", ")", List.<Integer>of(Integer.valueOf(1)), printMode, _function_2);
        };
    _function_1.accept(_defaultPrintTarget_1);
    DefaultPrintTarget _doubleArrow = _defaultPrintTarget_1;
    printed = _doubleArrow;
    ...
    final Consumer<DefaultPrintTarget> _function_2 =
        (DefaultPrintTarget it) -> {
          ...
          it.<Integer>printIterable(
              "(",
              ")",
              List.<Integer>of(Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(3)),
              printMode,
              _function_3);
        };
    _function_2.accept(_defaultPrintTarget_2);
    ...
    final Consumer<DefaultPrintTarget> _function_3 =
        (DefaultPrintTarget it) -> {
          final BiFunction<PrintTarget, Integer, PrintResult> _function_4 =
              (PrintTarget $0, Integer $1) -> {
                return $0.print(String.valueOf($1));
              };
          it.<Integer>printIterable(
    ...
    final Consumer<DefaultPrintTarget> _function_4 =
        (DefaultPrintTarget it) -> {
          final BiFunction<PrintTarget, Integer, PrintResult> _function_5 =
              (PrintTarget $0, Integer $1) -> {
                return $0.print(String.valueOf($1));
              };
          it.<Integer>printIterable(
  ...
  @Test
  @DisplayName(
      "returns NOT_RESPONSIBLE when printing an iterable the printer is not responsible for")
  public void iterableNotResponsible() {
    final DefaultPrintTarget target = new DefaultPrintTarget();
    final BiFunction<PrintTarget, Integer, PrintResult> _function =
        (PrintTarget $0, Integer $1) -> {
  ...
  public void iterableNotResponsibleAfterPrinted() {
    final Executable _function =
        () -> {
          final BiFunction<PrintTarget, Integer, PrintResult> _function_1 =
              (PrintTarget target, Integer number) -> {
  ...
  @Test
  @DisplayName(
      "tolerates if getting NOT_RESPONSIBLE after PRINTED_NO_OUTPUT when printing an iterable ")
  public void iterableNotResponsibleAfterPrintedNoOutput() {
    final DefaultPrintTarget target = new DefaultPrintTarget();
    final BiFunction<PrintTarget, Integer, PrintResult> _function =
        (PrintTarget subTarget, Integer number) -> {
          PrintResult _xblockexpression = null;
          {
            subTarget.print("bad");
            PrintResult _switchResult = null;
  ...
  public void nestedIterables() {
    ...
    final Consumer<DefaultPrintTarget> _function =
        (DefaultPrintTarget it) -> {
          final BiFunction<PrintTarget, List<List<Integer>>, PrintResult> _function_1 =
              (PrintTarget subTarget, List<List<Integer>> subList) -> {
                final BiFunction<PrintTarget, List<Integer>, PrintResult> _function_2 =
                    (PrintTarget subSubTarget, List<Integer> subSubList) -> {
                      final BiFunction<PrintTarget, Integer, PrintResult> _function_3 =
                          (PrintTarget $0, Integer $1) -> {
                            return $0.print(String.valueOf($1));
                          };
                      return subSubTarget.<Integer>printIterable(
                          "{", "}", subSubList, printMode, _function_3);
                    };
                return subTarget.<List<Integer>>printIterable(
                    "[", "]", subList, printMode, _function_2);
              };
          it.<List<List<Integer>>>printIterable(
              "(",
              ")",
              List.<List<List<Integer>>>of(
                  ...
                  List.<List<Integer>>of(
                      List.of(),
                      List.<Integer>of(Integer.valueOf(4), Integer.valueOf(4)),
                      List.<Integer>of(Integer.valueOf(5)))),
              printMode,
              _function_1);
        };
    _function.accept(_defaultPrintTarget);
