...
public final class DefaultModelPrinter implements ModelPrinter {
  ...
  private PrintResult _dispatchPrintObject(final PrintTarget target, final PrintIdProvider idProvider,
    ...
    final BiFunction<PrintTarget, URI, PrintResult> _function = (PrintTarget subTarget, URI uri) -> {
  ...
  private PrintResult _dispatchPrintObject(final PrintTarget target, final PrintIdProvider idProvider,
    ...
    PrintResult _xblockexpression = null;
    {
      ...
      Iterable<EAttribute> _filter = Iterables.<EAttribute>filter(eClass.getEAllAttributes(),
          it -> !Objects.equals(it, idAttribute));
  ...
  @Override
  public PrintResult printFeature(final PrintTarget target, final PrintIdProvider idProvider,
    ...
    if (_isMany) {
      ...
      if (_isOrdered) {
        ...
        _xifexpression_1 = this.subPrinter.printFeatureValueList(target, idProvider, object, feature,
            ((Collection<?>) _eGet));
      } else {
        Object _eGet_1 = object.eGet(feature);
        _xifexpression_1 = this.subPrinter.printFeatureValueSet(target, idProvider, object, feature,
            ((Collection<?>) _eGet_1));
      }
  ...
  public PrintResult printFeatureValueList(final PrintTarget target, final PrintIdProvider idProvider,
    ...
    final BiFunction<PrintTarget, Object, PrintResult> _function = (PrintTarget subTarget, Object element) -> {
  ...
  public PrintResult printFeatureValue(final PrintTarget target, final PrintIdProvider idProvider, final EObject object,
    ...
    if (!_matched) {
      final BiFunction<PrintTarget, Object, PrintResult> _function = (PrintTarget subTarget, Object theValue) -> {
  ...
  private PrintResult _dispatchPrintObjectShortened(final PrintTarget target,
      final PrintIdProvider idProvider, final Resource resource) {
    PrintResult _print = target.print("Resource@");
    final BiFunction<PrintTarget, URI, PrintResult> _function = (PrintTarget subTarget, URI uri) -> {
  ...
  private PrintResult _dispatchPrintObjectShortened(final PrintTarget target,
      final PrintIdProvider idProvider, final EObject object) {
    PrintResult _xblockexpression = null;
    {
  ...
  private PrintResult _dispatchPrintObjectShortened(final PrintTarget target,
      final PrintIdProvider idProvider, final String string) {
    PrintResult _xifexpression = null;
  ...
  private PrintResult _dispatchPrintObjectShortened(final PrintTarget target,
      final PrintIdProvider idProvider, final Object object) {
    PrintResult _switchResult = null;
    boolean _matched = false;
  ...
  private PrintResult _dispatchPrintObjectShortened(final PrintTarget target,
      final PrintIdProvider idProvider, final Void void_) {
    return target.print("∅");
  }
  ...
  private PrintResult dispatchPrintObject(final PrintTarget target, final PrintIdProvider idProvider,
      final Object object) {
  ...
  private PrintResult dispatchPrintObjectShortened(final PrintTarget target, final PrintIdProvider idProvider,
      final Object string) {
