...
public final class ModelMatchers {
  ...
  public static <E extends EObject> Matcher<Iterable<E>> containsAllOf(
      final Iterable<E> searchedItems, final ModelDeepEqualityOption... options) {
    return (Matcher<Iterable<E>>) (Matcher<?>) new EListMultipleContainmentMatcher(searchedItems, true, options);
  }
   ...
   */
  @SuppressWarnings("unchecked")
  public static <E extends EObject> Matcher<Iterable<E>> containsNoneOf(
      final Iterable<E> searchedItems, final ModelDeepEqualityOption... options) {
    return (Matcher<Iterable<E>>) (Matcher<?>) new EListMultipleContainmentMatcher(searchedItems, false, options);
  }
   ...
   */
  @SuppressWarnings("unchecked")
  public static <E extends EObject> Matcher<Iterable<E>> listContains(final EObject searchedItem,
      final ModelDeepEqualityOption... options) {
    return (Matcher<Iterable<E>>) (Matcher<?>) new EListSingleContainmentMatcher(searchedItem, true, options);
  }
  ...
  public static <T> Matcher<EObject> whose(final EStructuralFeature feature, final Matcher<T> featureMatcher) {
