...
public class ReplaceChangeDecoder extends AbstractChangeDecoder {
  ...
  /**
   * Constructs a decoder for a given eChange class. This class has to use oldValue and newValue as
  ...
  protected String generateString(EChange eChange, Map<String, Object> structuralFeatures2values) {
    ...
    if (!structuralFeatures2values.containsKey("oldValue")
        && !structuralFeatures2values.containsKey("newValue")) {
      return null;
    }
    ...
    String oldValue =
        structuralFeatures2values.containsKey("oldValue")
            ? structuralFeatures2values.get("oldValue").toString()
            : "-";
    String newValue =
        structuralFeatures2values.containsKey("newValue")
            ? structuralFeatures2values.get("newValue").toString()
            : "-";
