 ...
 * <p>
 * This view is deprecated and exists only to support {@code LegacyVitruvApplicationTest}. Do not use this class!
 */
...
public interface NonTransactionalTestView extends TestView {
   ...
   */
  <T extends Notifier> T startRecordingChanges(final T notifier);
   ...
   * Use {@link #record record} to run recording in a transaction that automatically stops recording on return.
   */
  <T extends Notifier> T stopRecordingChanges(final T notifier);
   ...
   */
  void setDisposeViewResourcesAfterPropagation(final boolean enabled);
}
